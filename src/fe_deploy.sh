...
cd /home/paddock1game/htdocs/www.paddock1game.com
...
git remote set-url origin https://$GITHUB_USERNAME:$GITHUB_TOKEN@github.com/$GITHUB_USERNAME/Paddock1-FE-Builder.git
echo "Haciendo pull..."
...
send "$SSH_PASSWORD\r"
expect "*\$ "
send "cd /home/paddock1game/htdocs/www.paddock1game.com\r"
expect "*\$ "
...
expect "*\$ "
send "git remote set-url origin https://$GITHUB_USERNAME:$GITHUB_TOKEN@github.com/$GITHUB_USERNAME/Paddock1-FE-Builder.git\r"
expect "*\$ "
